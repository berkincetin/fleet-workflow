...
_REQUIRED_FIELDS: dict[str, set[str]] = {
    ...
    "vehicle_intake": {"id", "report_lines", "segment"},
    "insights_publisher": {"id", "data_rows", "brand_voice"},
    "dealer_onboarding": {"id", "case_type", "application"},
    "legal_review": {"id", "case_type", "contract_text"},
}
